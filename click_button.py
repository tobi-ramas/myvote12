...
mobile_user_agent = "Mozilla/5.0 (Linux; Android 11; Pixel 5) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/89.0.4389.105 Mobile Safari/537.36"
...
try:
    ...
    driver.add_cookie({'name': 'PHPSESSID', 'value': '76158188c45d96c14c31ad1dc2fef89d'})
    time.sleep(2)
    # to refresh the page
    driver.refresh()
